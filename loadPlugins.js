...
var plgs = [...doc.querySelectorAll(".tablebox")].filter(i => i.querySelector('img[alt="2.x"]')).map(i => {
  ...
  var el;
	...
	sourceCode: sourceCode && !sourceCode.startsWith("http") ? "https://keepass.info/" + sourceCode : sourceCode,
	download: pluginDownload && !pluginDownload.startsWith("http") ? "https://keepass.info/" + pluginDownload : pluginDownload,
	website: website && !website.startsWith("http") ? "https://keepass.info/" + website : website,
